...
Open the browser console for the full stack trace.`)}catch{}}function H(t,e){return((...o)=>{try{let r=e(...o);return r&&typeof r.then=="function"&&r.catch(s=>g(t,s)),r}catch(r){g(t,r)}})}async function It(t){let e=new TextEncoder().encode(t),o=await crypto.subtle.digest("SHA-256",e);return Array.from(new Uint8Array(o),r=>r.toString(16).padStart(2,"0")).join("")}function Ct(t){let e=new URLSearchParams;for(let[r,s]of Object.entries(t||{}))s!=null&&e.set(r,typeof s=="string"?s:JSON.stringify(s));let o=e.toString();return o?"?"+o:""}function G(t,e,{params:o,body:r,headers:s}={}){let a=l.serverAddress+e+Ct(o),c=Object.assign({"X-Client-Name":J},s||{});if(typeof GM_xmlhttpRequest=="function")return new Promise(p=>{let u=!1,m=y=>{u||(u=!0,clearTimeout(b),p(y))},b=setTimeout(()=>m({status:0,text:""}),2e4);GM_xmlhttpRequest({method:t,url:a,headers:r?Object.assign({"Content-Type":"application/json"},c):c,data:r?JSON.stringify(r):void 0,onload:y=>m({status:y.status,text:y.responseText}),onerror:()=>m({status:0,text:""}),ontimeout:()=>m({status:0,text:""})})});let d=r?Object.assign({"Content-Type":"application/json"},c):c;return fetch(a,{method:t,headers:d,body:r?JSON.stringify(r):void 0}).then(async p=>({status:p.status,text:await p.text()})).catch(()=>({status:0,text:""}))}var S=new Map;var Dt=180*1e3;function Pt(){return ct.filter(t=>l.categoryActions[t]!=="off")}async function N(t){let e=S.get(t);if(e&&Date.now()-e.fetchedAt<Dt)return e.segments;let o=Pt();if(o.length===0)return S.set(t,{segments:[],fetchedAt:Date.now()}),[];try{let r=(await It(t)).slice(0,5),s=await G("GET","/api/skipSegments/"+r,{params:{categories:o,actionTypes:["skip","mute","poi"]}}),a=[];if(s.status===200){let c=JSON.parse(s.text),d=Array.isArray(c)?c.find(p=>p.videoID===t):null;d&&Array.isArray(d.segments)&&(a=d.segments.map(p=>({uuid:p.UUID,category:p.category,actionType:p.actionType,start:p.segment[0],end:p.segment[1],locked:!!p.locked,votes:p.votes})).sort((p,u)=>p.start-u.start))}return S.set(t,{segments:a,fetchedAt:Date.now()}),a}catch(r){return console.error("[SponsorBlock Mobile] Failed to fetch segments",r),[]}}function X(t,e){return G("POST","/api/voteOnSponsorTime",{params:{UUID:t,userID:l.userID,type:e}})}function q(t,e){return G("POST","/api/viewedVideoSponsorTime",{params:{UUID:t,videoID:e}})}function gt(t,e,o){return G("POST","/api/skipSegments",{body:{videoID:t,userID:l.userID,videoDuration:o,userAgent:J,segments:e.map(r=>({segment:[r.start,r.end],category:r.category,actionType:r.actionType}))}})}var Ut=`
    ...
    `;function K(){let t=document.head||document.documentElement;if(!t){window.requestAnimationFrame(K);return}let e=document.createElement("style");e.textContent=Ut,t.appendChild(e)}function i(t,e,o){let r=document.createElement(t);for(let[s,a]of Object.entries(e||{}))s==="class"?r.className=a:s==="text"?r.textContent=a:s.startsWith("on")&&typeof a=="function"?r.addEventListener(s.slice(2),H(`<${t}> ${s}`,a)):r.setAttribute(s,a);for(let s of o||[])s&&r.appendChild(typeof s=="string"?document.createTextNode(s):s);return r}function T(t){t=Math.max(0,Math.round(t));let e=Math.floor(t/3600),o=Math.floor(t%3600/60),r=t%60,s=e>0?String(o).padStart(2,"0"):String(o),a=String(r).padStart(2,"0");return e>0?`${e}:${s}:${a}`:`${s}:${a}`}function z(t){let e=V.get(t);return e?e.name:t}function D(t){try{let e=new URL(t);if(e.searchParams.has("v"))return e.searchParams.get("v");let o=e.pathname.match(/\/shorts\/([\w-]{11})/);if(o)return o[1];let r=e.pathname.match(/\/live\/([\w-]{11})/);return r?r[1]:null}catch{return null}}function W(){return document.getElementById("movie_player")}function f(){let t=W();return t&&t.querySelector("video")||document.querySelector("video")}function Q(){let t=W();return!!t&&t.classList.contains("ad-showing")}function E(){let t=W();if(t){let e=t.getBoundingClientRect();if(e.width>0&&e.height>0)return e}return{top:0,left:0,right:window.innerWidth,width:window.innerWidth,height:Math.round(window.innerWidth*9/16)}}function bt(){let t=document.querySelectorAll("yt-progress-bar.ytPlayerProgressBarHost");if(!t.length)return null;for(let e of t)if(e.classList.contains("watch-page-progress-bar"))return e;return t[0]}function P(){n.poiChipEl&&(n.poiChipEl.remove(),n.poiChipEl=null)}function ht(t){if(n.poiChipEl)return;let e=i("button",{class:"sbm-poi-chip",text:"★ Jump to highlight",onclick:()=>{let r=f();r&&(r.currentTime=t.start),P(),n.poiShown=!0}}),o=E();e.style.left=o.left+o.width/2+"px",e.style.top=o.top+14+"px",document.body.appendChild(e),n.poiChipEl=e}function U(){document.querySelectorAll(".sbm-progress-overlay").forEach(t=>t.remove())}function Rt(t,e){let o=t.querySelector("yt-progress-bar-line, .ytProgressBarLineHost");if(o){let r=t.getBoundingClientRect(),s=o.getBoundingClientRect();if(r.height>0&&s.height>0){e.style.top=s.top-r.top+"px",e.style.height=s.height+"px",e.style.transform="none";return}}e.style.top="",e.style.height="",e.style.transform=""}function R(){if(!l.showProgressBarSegments){U();return}let t=f(),e=bt();if(!e||!t||!isFinite(t.duration)||t.duration<=0)return;let o=e.querySelector(":scope > .sbm-progress-overlay");if(o||(getComputedStyle(e).position==="static"&&(e.style.position="relative"),o=i("div",{class:"sbm-progress-overlay"}),e.appendChild(o),o.dataset.videoId=""),Rt(e,o),o.dataset.videoId===n.videoID&&o.dataset.count===String(n.segments.length))return;for(;o.firstChild;)o.removeChild(o.firstChild);let r=t.duration;for(let s of n.segments){if(s.actionType==="poi")continue;let a=V.get(s.category),c=Math.max(0,s.start/r*100),d=Math.max(.3,(s.end-s.start)/r*100),p=i("div",{class:"sbm-progress-seg",style:`left:${c}%;width:${d}%;background:${a?a.color:"#fff"};`});o.appendChild(p)}o.dataset.videoId=n.videoID??"",o.dataset.count=String(n.segments.length)}function B(){n.toastEl&&(n.toastEl.remove(),n.toastEl=null),n.toastTimer&&(clearTimeout(n.toastTimer),n.toastTimer=null)}function xt(t,e){B();let o=t.length===1,r=o?`Skipped ${z(t[0].category)}`:`Skipped ${t.length} segments`,s=i("button",{text:"Undo",onclick:()=>{let p=f();p&&(p.currentTime=Math.max(0,e));for(let u of t)n.overriddenUUIDs.add(u.uuid);B()}}),a=[i("span",{text:r}),s];if(o&&t[0].uuid){let p=t[0],u=i("button",{class:"sbm-vote-btn",text:"👍",onclick:()=>{u.classList.add("sbm-voted"),X(p.uuid,1)}}),m=i("button",{class:"sbm-vote-btn",text:"👎",onclick:()=>{m.classList.add("sbm-voted"),X(p.uuid,0)}});a.push(u,m)}let c=i("div",{class:"sbm-toast"},a),d=E();c.style.left=d.left+d.width/2+"px",c.style.top=d.top+d.height*.8+"px",document.body.appendChild(c),n.toastEl=c,n.toastTimer=setTimeout(H("toast auto-dismiss",B),4e3)}var M=null;function $(){M&&(M.remove(),M=null)}function _(){$();let t=h.map(c=>{let d=l.categoryActions[c.key],p=c.isPoi?[["off","Off"],["notify","Show"],["skip","Auto-jump"]]:[["off","Off"],["notify","Manual"],["skip","Auto-skip"]],u=i("div",{class:"sbm-seg-toggle"},p.map(([m,b])=>i("button",{text:b,class:m===d?"active":"",onclick:y=>{l.setCategoryAction(c.key,m);for(let x of Array.from(u.children))x.classList.remove("active");y.target.classList.add("active"),S.delete(n.videoID??""),n.videoID&&O(n.videoID)}})));return i("div",{class:"sbm-row"},[i("div",{class:"sbm-row-label"},[i("b",{},[c.name,i("sup",{class:"sbm-cat-swatch",style:`background:${c.color};`})]),i("a",{href:`https://wiki.sponsor.ajay.app/w/${encodeURIComponent(c.name.replace(/ /g,"_"))}`,target:"_blank",rel:"noopener",text:"wiki"})]),u])}),e=i("label",{class:"sbm-switch"},[i("input",Object.assign({type:"checkbox",onchange:c=>{l.enabled=c.target.checked,l.save("enabled")}},l.enabled?{checked:"checked"}:{})),i("span",{class:"track"}),i("span",{class:"thumb"})]),o=i("label",{class:"sbm-switch"},[i("input",Object.assign({type:"checkbox",onchange:c=>{l.showProgressBarSegments=c.target.checked,l.save("showProgressBarSegments"),c.target.checked?R():U()}},l.showProgressBarSegments?{checked:"checked"}:{})),i("span",{class:"track"}),i("span",{class:"thumb"})]),r=i("input",{type:"text",value:l.serverAddress,onchange:c=>{l.serverAddress=c.target.value.replace(/\/$/,"")||I,l.save("serverAddress"),S.clear()}}),s=i("div",{class:"sbm-stats"},[i("div",{},[i("b",{text:String(l.stats.segmentsSkipped)}),i("span",{text:"segments skipped"})]),i("div",{},[i("b",{text:T(l.stats.secondsSaved)}),i("span",{text:"time saved"})])]),a=i("div",{class:"sbm-sheet"},[i("h2",{},[document.createTextNode("SponsorBlock Settings"),i("button",{class:"sbm-close",text:"✕",onclick:$})]),i("div",{class:"sbm-row"},[i("div",{class:"sbm-row-label"},[i("b",{text:"Enabled"})]),e]),i("div",{class:"sbm-row"},[i("div",{class:"sbm-row-label"},[i("b",{text:"Show segments on seek bar"})]),o]),s,i("button",{class:"sbm-btn-secondary",text:"Reset stats",onclick:()=>{l.resetStats(),$(),_()}}),i("h2",{style:"margin-top:18px;font-size:14px;color:#aaa;"},[document.createTextNode("Categories")]),...t,i("div",{class:"sbm-row-label",style:"margin-top:14px;"},[i("b",{text:"Server address"}),r])]);M=i("div",{class:"sbm-overlay-screen",onclick:c=>{c.target===M&&$()}},[a]),document.body.appendChild(M)}var v=null;function Z(){v&&(v.remove(),v=null)}function w(){let t=i("div",{},n.pendingSubmission.map((u,m)=>{let b=u.actionType==="poi",y=b?i("span",{class:"sbm-pending-category",text:"Highlight"}):i("select",{onchange:x=>{u.category=x.target.value}},h.filter(x=>!x.isPoi).map(x=>i("option",Object.assign({value:x.key,text:x.name},x.key===u.category?{selected:"selected"}:{}))));return i("div",{class:"sbm-pending-item"},[i("span",{class:"sbm-time",text:b?T(u.start):`${T(u.start)} → ${T(u.end)}`}),y,i("button",{class:"sbm-del",text:"✕",onclick:()=>{n.pendingSubmission.splice(m,1),w()}})])})),e=f(),o=i("button",{class:"sbm-btn-secondary",text:"Mark start → end",onclick:()=>{e&&(n.pendingSubmission.push({start:e.currentTime,end:e.currentTime+1,category:"sponsor",actionType:"skip"}),w())}}),r=i("button",{class:"sbm-btn-secondary",text:"Mark highlight",onclick:()=>{e&&(n.pendingSubmission.push({start:e.currentTime,end:e.currentTime,category:"poi_highlight",actionType:"poi"}),w())}}),s=n.pendingSubmission[n.pendingSubmission.length-1],a=s&&s.actionType!=="poi",c=i("button",{class:"sbm-btn-secondary",text:"Set end = now",onclick:()=>{!e||!a||(s.end=e.currentTime,w())}}),d=i("button",{class:"sbm-btn-primary",text:n.pendingSubmission.length?`Submit ${n.pendingSubmission.length} segment(s)`:"Nothing to submit",onclick:async()=>{if(!n.pendingSubmission.length||!e)return;let u=n.pendingSubmission.filter(b=>b.actionType==="poi"||b.end>b.start);if(!u.length)return;let m=await gt(n.videoID,u,e.duration);m.status===200?(n.pendingSubmission=[],S.delete(n.videoID??""),Z(),n.videoID&&O(n.videoID)):alert("Submission failed (server said: "+m.status+"). Your segments were kept so you can retry.")}}),p=i("div",{class:"sbm-sheet"},[i("h2",{},[document.createTextNode("Submit a segment"),i("button",{class:"sbm-close",text:"✕",onclick:Z})]),i("div",{class:"sbm-mark-row"},[o,r]),a?i("div",{class:"sbm-mark-row"},[c]):null,t,d]);v?v.querySelector(".sbm-sheet").replaceWith(p):(v=i("div",{class:"sbm-overlay-screen",onclick:u=>{u.target===v&&Z()}},[p]),document.body.appendChild(v))}var j=null,tt=!1;function L(){j&&(j.style.display=n.videoID&&tt?"flex":"none")}function _t(t){tt=t,L()}function yt(){let t=i("button",{class:"sbm-fab",text:"⚙",title:"SponsorBlock settings",onclick:_}),e=i("button",{class:"sbm-fab",text:"+",title:"Submit a segment",onclick:w});j=i("div",{class:"sbm-fab-row"},[e,t]),document.body.appendChild(j),L()}function Ot(){return document.querySelector(".slim-video-action-bar-actions")}function et(){let t=Ot();if(!t||t.querySelector(":scope > .sbm-action-bar-btn"))return;let e=i("button",{class:"sbm-action-bar-btn","aria-label":"SponsorBlock",title:"SponsorBlock",text:"⏭",onclick:()=>_t(!tt)});t.appendChild(e)}function St(t,e){let o=[t[e]],r=t[e].end;for(let s=e+1;s<t.length;s++){let a=t[s];if(a.start>r+.5)break;F(a.category)==="skip"&&(n.overriddenUUIDs.has(a.uuid)||(r=Math.max(r,a.end),o.push(a)))}return{end:r,involved:o}}var vt=.75;function nt(t,e){return isFinite(e.duration)&&e.duration>0&&t>=e.duration-vt?Math.max(0,e.duration-vt):t}function F(t){return l.categoryActions[t]||"off"}function rt(){window.requestAnimationFrame(rt);try{if(!l.enabled)return;let t=f();if(!t||Q()||t.paused||D(location.href)!==n.videoID)return;let o=t.currentTime;Tt(t,o),st(t,o),Vt(t,o)}catch(t){g("tick",t)}}function Tt(t,e){let r=n.segments.filter(s=>s.actionType==="mute"&&F(s.category)!=="off"&&!n.overriddenUUIDs.has(s.uuid)).find(s=>e>=s.start-.15&&e<s.end);r&&n.activeMuteUUID!==r.uuid?(n.wasMutedBeforeSegment=t.muted,t.muted=!0,n.activeMuteUUID=r.uuid):!r&&n.activeMuteUUID&&(t.muted=n.wasMutedBeforeSegment,n.activeMuteUUID=null)}function st(t,e){let o=n.segments.filter(r=>r.actionType==="skip").sort((r,s)=>r.start-s.start);for(let r=0;r<o.length;r++){let s=o[r],a=F(s.category);if(a!=="off"&&!n.overriddenUUIDs.has(s.uuid)&&!(a==="skip"&&n.autoSkippedUUIDs.has(s.uuid))&&!(e<s.start-.15||e>=s.end)){if(a==="skip"){let{end:c,involved:d}=St(o,r);if(c<=e)continue;let p=e,u=nt(c,t);t.currentTime=u;for(let m of d)n.autoSkippedUUIDs.add(m.uuid);l.addStats(u-p),xt(d,p);for(let m of d)q(m.uuid,n.videoID);return}else if(a==="notify"){if(n.shownManualUUIDs.has(s.uuid))continue;let{end:c}=St(o,r);Et(s,c);return}}}n.manualBtnUUID&&(o.some(s=>s.uuid===n.manualBtnUUID&&e>=s.start-.15&&e<s.end)||A())}function Vt(t,e){let o=n.segments.find(a=>a.actionType==="poi");if(!o)return;let r=F(o.category);if(r==="off")return;if(r==="skip"&&!n.poiAutoJumped&&e<o.start&&e<3){n.poiAutoJumped=!0,t.currentTime=o.start;return}let s=Math.max(0,o.start-20);!n.poiShown&&!n.poiChipEl&&e>=s&&e<o.start-1&&ht(o),n.poiChipEl&&(e>=o.start-1||e<s)&&P()}async function O(t){try{at(t);let e=await N(t);if(n.videoID!==t)return;n.segments=e;let o=f();o&&!Q()&&(st(o,o.currentTime),Tt(o,o.currentTime)),R(),et(),L()}catch(e){g("loadVideo",e)}}var wt=null,kt=null;function it(){try{Ht()}catch(t){g("pollNavigation",t)}}function Ht(){let t=location.href,e=D(t);t!==wt&&(wt=t,e!==n.videoID&&(e?O(e):at(null)));let o=f();o&&o!==kt&&(kt=o,e&&e===n.videoID&&st(o,o.currentTime)),R(),et(),L()}function A(){n.manualBtnEl&&(n.manualBtnEl.remove(),n.manualBtnEl=null,n.manualBtnUUID=null)}function Et(t,e){if(n.manualBtnUUID===t.uuid)return;A();let o=i("button",{class:"sbm-manual-btn",onclick:()=>{let s=f();if(s){let a=s.currentTime,c=nt(e,s);s.currentTime=c,l.addStats(c-a),q(t.uuid,n.videoID)}n.shownManualUUIDs.add(t.uuid),A()}},[document.createTextNode(`Skip ${z(t.category)} ▶`)]),r=E();o.style.left=r.left+r.width-12+"px",o.style.top=r.top+r.height*.72+"px",o.style.transform="translateX(-100%)",document.body.appendChild(o),n.manualBtnEl=o,n.manualBtnUUID=t.uuid}var n={videoID:null,segments:[],overriddenUUIDs:new Set,autoSkippedUUIDs:new Set,shownManualUUIDs:new Set,poiShown:!1,poiAutoJumped:!1,activeMuteUUID:null,wasMutedBeforeSegment:!1,pendingSubmission:[],toastEl:null,toastTimer:null,manualBtnEl:null,manualBtnUUID:null,poiChipEl:null};function at(t){n.videoID=t,n.segments=[],n.overriddenUUIDs=new Set,n.autoSkippedUUIDs=new Set,n.shownManualUUIDs=new Set,n.poiShown=!1,n.poiAutoJumped=!1,n.activeMuteUUID=null,n.wasMutedBeforeSegment=!1,n.pendingSubmission=[],B(),A(),P(),U()}async function Gt(){if(!window.__sbMobileLoaded&&(window.__sbMobileLoaded=!0,!window.frameElement)){try{await dt()}catch(t){g("initConfig",t)}try{K()}catch(t){g("injectStyles",t)}try{typeof GM_registerMenuCommand=="function"&&(GM_registerMenuCommand("SponsorBlock Settings",_),GM_registerMenuCommand("Submit a segment",w))}catch(t){g("GM_registerMenuCommand",t)}Mt(),window.__sbMobileDebug={Config:l,PlaybackState:n,CATEGORIES:h,getVideoIDFromURL:D,fetchSegments:N}}}function Mt(){if(!document.body){window.requestAnimationFrame(Mt);return}try{yt(),window.requestAnimationFrame(rt),setInterval(it,500),it()}catch(t){g("boot",t)}}Gt().catch(t=>g("main",t));})();
